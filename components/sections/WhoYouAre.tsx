...
export default function WhoYouAre() {
  ...
  return (
    <section className="py-20 md:py-32 px-4 sm:px-6 lg:px-8 bg-scallop-blue relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 md:mb-6 tracking-tight leading-[1.1]">
              Who you are
            </h2>
